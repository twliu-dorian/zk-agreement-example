...
const LINEBREAK_RULE = {
  deserialize(el, next, ignoreSpace) {
    if (el.tagName && el.tagName.toLowerCase() === 'br') {
      return {
        '$class': "".concat(NS_PREFIX_CommonMarkModel, "Linebreak")
      };
    }
  }
...
const rules = [LIST_RULE, PARAGRAPH_RULE, STRONG_RULE, EMPH_RULE, LINK_RULE, HEADING_RULE, THEMATIC_BREAK_RULE, LINEBREAK_RULE, CODE_BLOCK_RULE, INLINE_CODE_RULE, BLOCK_QUOTE_RULE, CLAUSE_RULE, VARIABLE_RULE, CONDITIONAL_RULE, OPTIONAL_RULE, FORMULA_RULE, TEXT_RULE, HTML_INLINE_RULE, HTML_BLOCK_RULE, IMAGE_RULE];
