...
class ToCiceroMarkVisitor {
  ...
  deserializeElements() {
    ...
    let ignoreSpace = arguments.length > 1 ? arguments[1] : undefined;
    let nodes = [];
    elements.filter(this.cruftNewline).forEach(element => {
      // console.log('element -- ', element);
      const node = this.deserializeElement(element, ignoreSpace); // console.log('node -- ', node);
  ...
  toCiceroMark(input) {
    ...
    const nodes = this.deserializeElements(children, true); // console.log('nodes', nodes);
