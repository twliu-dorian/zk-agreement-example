...
describe('ciceromark <-> html', () => {
  getCiceroMarkFiles().forEach((_ref2, index) => {
    let [file, jsonText] = _ref2;
    it("converts ".concat(file, " to and from CiceroMark"), () => {
      const value = JSON.parse(jsonText);
      const html = htmlTransformer.toHtml(value); // check no changes to html
      ...
      expect(html).toEqual(expectedHtml); // check roundtrip
